...
export function PageContainer({
  ...
  return (
    <div className={cn("mx-auto w-full space-y-6", className)}>{children}</div>
  );
}
...
export function SectionHeader({
  ...
  return (
    ...
    >
      ...
      {actions ? (
        <ActionGroup className="w-full md:w-auto">{actions}</ActionGroup>
      ) : null}
    </div>
  );
}
...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-[rgba(137,81,41,0.12)] bg-[#faf7f3] px-6 py-10 text-center",
        className,
      )}
    >
