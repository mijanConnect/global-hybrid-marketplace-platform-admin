...
export default function DeliveryDriverDetailsPage() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetDeliveryDriverQuery(id ?? "", { skip: !id });
  ...
  const statItems = useMemo(() => {
    ...
    return [
      ...
      {
        label: "Rating",
        value: driver.ratingCount ? driver.rating.toFixed(2) : "—",
      },
  ...
  function handleLiveMap() {
    dispatch(
      pushNotification({
        kind: "delivery",
        title: "Map",
        description: "Scroll to map section.",
      }),
    );
    document
      .getElementById("driver-live-map")
    ...
    >
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_280px]">
        <div className="min-w-0 space-y-6">
          ...
          <Card
            id="driver-live-map"
            className="scroll-mt-24 rounded-xl border-[#EEE7DF] shadow-soft"
          >
